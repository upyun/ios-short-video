...
- (void)commonInit {
    ...
    HorizontalListItemView *resetItemView = [CameraBeautyFaceListItemView itemViewWithImage:[UIImage imageNamed:@"face_ic_reset"] title:NSLocalizedStringFromTable(@"tu_重置", @"VideoDemo", @"重置")];
